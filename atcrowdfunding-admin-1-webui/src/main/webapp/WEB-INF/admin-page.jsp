			...
			$.ajax({
				...
				"success":function(response) {
					if(response.result == "SUCCESS"){
                           alert("删除成功");
                           var xx = ${requestScope["PAGE-INFO"].pageNum};
                        location.href="admin/query/for/search?pageNum="+xx+"&keyword=${param.keyword}";
					}else{
                        alert("删除失败！");
					}
				},
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form action="admin/query/for/search" class="form-inline" role="form" style="float: left;" method="post">
						...
						<button type="button" class="btn btn-primary"
							style="float: right;" onclick="window.location.href='admin/add'">
